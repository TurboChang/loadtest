...
if __name__ == '__main__':
    ...
    for cls in testinfo:
        ...
        if db_type == "greenplum":
            ins_data = InsertJdbcPG(cls, 'customer', 'greenplum')
            load_data = LoadPsqlPG(cls, 'customer', 'greenplum')

            if ins_data:
                start_time = datetime.datetime.now()
                ins_data.insert()
                db_cost(start_time, "Pg insert data cost:", "gp_insert")

            if load_data:
                start_time = datetime.datetime.now()
                load_data.copy()
                db_cost(start_time, "Pg insert data cost:", "gp_load")